...
rrdFlot.prototype.createHTML = function() {
  ...
  var base_el=document.getElementById(this.html_id);
    ...
    base_el.style.backgroundColor = '#fff';
    base_el.style.opacity = 0.70;
...
// CST
  ...
  cellGraph.colSpan=1; /*CST 3*/
  cellGraph.rowSpan=2; /*CST */
  var elGraph=document.createElement("Div");
// CST
    elGraph.style.backgroundColor = '#fff';
// CST
...
//CST removed  var cellScale=rowGraph.insertCell(-1);
  ...
  cellScale.appendChild(elScale);
    ...
    cellScale.style.backgroundColor = '#fff';
    //cellScale.style..opacity = 0.70;


  var cellScaleLegend=rowScale.insertCell(-1);
//CST added
    cellScaleLegend.style.display = 'none';
//CST
...
/* CST 
  ...
  cellGraph.appendChild(elScaleReset);
*/
